...
//실행해보면 다음과 같은 이상한 결과가 나온다. 생성자 호출, url = null
//connect: null
...
//스프링은 크게 3가지 방법으로 빈 생명주기 콜백을 지원한다. 인터페이스(InitializingBean, DisposableBean)
//설정 정보에 초기화 메서드, 종료 메서드 지정 @PostConstruct, @PreDestroy 애노테이션 지원
//하나씩 알아보자.
